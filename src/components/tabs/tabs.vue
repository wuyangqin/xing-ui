<template>
  <div class="xx-tabs" :class="tabsClasses">
    <div class="xx-tab__header">
...
.xx-tabs {
  ...
  &.tabs-bottom {
    ...
    .xx-tab__header { margin-top: @tabs-margin-num; }
  }
  &.tabs-left, &.tabs-right {
    flex-direction: row;
    .xx-tab__header { height: 100%; }
  }
  &.tabs-left {
    flex-direction: row;
    .xx-tab__header { margin-right: @tabs-margin-num; }
  }
  &.tabs-right {
    flex-direction: row-reverse;
    .xx-tabs__content { width: 100%; }
    .xx-tab__header { margin-left: @tabs-margin-num; flex-shrink: 0; }
  }
}
</style>
